...
```sh
pixlet check openmeteoweather.star
pixlet render openmeteoweather.star
pixlet serve openmeteoweather.star
```
...
```sh
pixlet render openmeteoweather.star 'location={"lat":"59.3293","lng":"18.0686","timezone":"Europe/Stockholm"}'
```

Keep `openmeteoweather.star` and `manifest.yaml` together when adding the app
